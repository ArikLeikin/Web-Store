document.addEventListener("DOMContentLoaded", function () {
  ...
  $(document).ready(function () {
    ...
    $("#purchase-form").submit(function (event) {
      ...
      if (!validateCardNumber(cardNumber) ||!validateCardNumber(cardNumber1) || !validateCardNumber(cardNumber2) || !validateCardNumber(cardNumber3)) {
